...
demos.Collection = Backbone.Collection.extend({
	...
	// Send request to api.github.com/repos/getbowtied-kits-templates-and-patterns
...
demos.view.Demo = wp.Backbone.View.extend({
	...
	importDemo: function( event ) {
		...
		$.confirm( {
            ...
            animation: 'scale',
            type: 'blue',
			title : '<br />Before Importing: Important Tips!',
...
demos.view.Preview = wp.Backbone.View.extend({
	...
	render: function() {
		...
		this.$el.fadeIn( 200, function() {
			$body.addClass( 'kits-templates-and-patterns-active full-overlay-active' );
		});
	...
	close: function() {
		this.$el.fadeOut( 200, function() {
			$( 'body' ).removeClass( 'kits-templates-and-patterns-active full-overlay-active' );
...
demos.Router = Backbone.Router.extend({
	...
	routes: {
		'themes.php?page=kits-templates-and-patterns&demo=:slug': 'preview',
		'themes.php?page=kits-templates-and-patterns&browse=:sort': 'sort',
		'themes.php?page=kits-templates-and-patterns&search=:query': 'search',
		'themes.php?page=kits-templates-and-patterns': 'sort'
	},

	baseUrl: function( url ) {
		return 'themes.php?page=kits-templates-and-patterns' + url;
	},
...
$( document ).ready( function() {
	...
	$( '.getbowtied-kits-templates-and-patterns-rating-link' ).on( 'click', function() {
		var $this_el = $( this );
